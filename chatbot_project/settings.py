...
# Use basic storage to allow serving dynamic files without manifest
STATICFILES_STORAGE = "whitenoise.storage.CompressedStaticFilesStorage"

# WhiteNoise settings for dynamic files
...
DIFY_TIMEOUT = int(os.environ.get('DIFY_TIMEOUT', '120'))